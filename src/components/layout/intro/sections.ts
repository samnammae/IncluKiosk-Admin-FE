...
import K8 from "@/assets/mockups/7.webp";
import K9 from "@/assets/mockups/7.webp";
...
export const sections: SectionType[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "별도의 조작 없이 편리하게 접근 가능한 환경을 제공합니다.",
    ],
    images: [K2], // 임의 이미지
    isKiosk: true,
  },
  {
    ...
    title: "음성 & 챗봇 주문 기능",
    description: [
      "음성 인식을 통해 복잡한 화면 조작 없이 빠르게 주문할 수 있습니다.",
    ],
    images: [K4],
    isKiosk: true,
  },
  {
    ...
    title: "스마트 관리자 페이지",
    description: [
      "대시보드를 통해 통계와 시각화를 확인하고, 매출 현황을 한눈에 파악할 수 있습니다.",
      "여러 매장을 운영하더라도 매장별 주문 내역과 데이터를 쉽게 관리할 수 있습니다.",
      "메뉴 등록, 수정, 삭제를 직관적으로 수행할 수 있어 효율적인 메뉴 관리가 가능합니다.",
